...
- 002-auth-user-mgmt: Added Java 21 LTS + Spring Boot 3.5.x, Spring Security 6.x, jOOQ 3.19, Liquibase 4.x, nimbus-jose-jwt 9.x, SpringDoc OpenAPI 2.x, commons-lang3 3.17.0

- 001-foundation-infra: Added Java 21 LTS + Spring Boot 3.5.x, jOOQ 3.19, Liquibase 4.x,
